...
import io.github.jlmc.settings.client.auth.ClientCredentials;
...
import io.github.jlmc.settings.client.http.ClientHttpExecutor;
import io.github.jlmc.settings.client.http.DefaultClientHttpExecutor;
import io.github.jlmc.settings.client.http.HttpConstants;
import io.github.jlmc.settings.client.http.HttpStatusCode;
...
public class ClientCredentialsStrategyIT {
    ...
    private static class RetryExecutorMock implements RetryExecutor {
        private int calls = 0;
        @Override
